    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        shareAppButton.setOnClickListener {
            ...
            shareIntent.setType("text/plain")
                .putExtra(
                    Intent.EXTRA_TEXT,
                    getString(R.string.yp_android_course_link)
                )
            startActivity(
                Intent.createChooser(
                    shareIntent,
                    getString(R.string.share_apk_text)
                )
            )
        }
        ...
        writeToSupportButton.setOnClickListener {
            ...
            writeToSupportIntent.setType("message/rfc822")
                ...
                .putExtra(
                    ...
                    getString(R.string.message_for_android_developers)
                )
                .putExtra(
                    Intent.EXTRA_TEXT,
                    getString(R.string.acknowledge_for_android_dev)
                )
            startActivity(
                Intent.createChooser(
                    writeToSupportIntent,
                    getString(R.string.write_to_support)
                )
            )
        }
        ...
        userAgreementButton.setOnClickListener {
            val userAgreementIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse(getString(R.string.yp_offertory_link))
            )
